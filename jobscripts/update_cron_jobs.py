...
# Generate cron file in local repo (reference only - manually copy to /etc/cron.d/ when needed)
cron_file = "/home/yostfundsadmin/client_etl_workflow/cron/etl_jobs"
...
cur.close()
conn.close()
print(f"Cron file generated: {cron_file}")
print("To apply: sudo cp cron/etl_jobs /etc/cron.d/etl_jobs && sudo chown root:root /etc/cron.d/etl_jobs")